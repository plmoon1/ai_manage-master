...
public interface PlanConstants {
    ...
    String ATTRIBUTE_ERROR = "任务性质列所填数据不存在！";

    String TYPE_ERROR = "任务类型列所填数据不存在！";

    String IMP_ERROR = "重要程度列所填数据不存在！";
    String STATUS_ERROR = "任务状态列所填数据不存在！";

    String HEAD_ERROR = "负责人未填写！";
    String NAME_ERROR = "任务名称未填写！";
    String DETAIL_ERROR = "任务详情未填写！";

    String ISOPEN_ERROR = "可见范围填写错误！";
    String ISSHOW_ERROR = "大屏展示填写错误！";

    String DID_MISSING = "任务所属部门未填写！";

    String ATTRIBUTE_MISSING = "任务性质未填写！";

    String IMP_MISSING = "重要程度未填写！";

    String STATUS_MISSING = "任务状态未填写！";

    String ISOPEN_MISSING = "可见范围未填写！";
    String ISSSHOW_MISSING = "大屏展示未填写！";

    String START_TIME_MISSING = "任务开始时间未填写";
    String END_TIME_MISSING = "任务结束时间未填写";

    String TYPE_MISSING = "任务类型未填写！";
}
